...
def main():
    ...
    from mt5docker import MT5_DEFAULT_PORT
    ...
    parser.add_argument(
        ...
        "--port",
        type=int,
        default=MT5_DEFAULT_PORT,
        help=f"The TCP listener port (default = {MT5_DEFAULT_PORT})",
    )
    parser.add_argument(
        "-w",
        "--wine",
    ...
    parser.add_argument(
        ...
        "--server",
        type=str,
        default="/tmp/mt5docker",
        help="Path where the server will be build and run (default = /tmp/mt5docker)",
    )
